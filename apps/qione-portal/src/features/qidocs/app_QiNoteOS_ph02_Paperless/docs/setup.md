...
-   Stick with SQLite to save some resources. See [troubleshooting](apps/qione/src/features/documents/app_QiNoteOS_ph02_Paperless/docs/troubleshooting.md#log-reports-creating-paperlesstask-failed)
